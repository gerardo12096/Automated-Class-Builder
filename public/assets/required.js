...
for (var i = 0; i < required.length; i++) {
    ...
    (async () => {
        let sql = "SELECT Department, courseNumber, grade FROM CourseCompletedByStudent WHERE StudentId = 200507859 AND (Department = 'MATH' OR Department = 'COMP' OR Department = 'PHIL') AND CourseNumber = '" + cno + "';";
